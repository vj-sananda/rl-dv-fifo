...
async def train_fifo(dut):
    ...
    async def mc_control(num_episodes, alpha, gamma=GAMMA, eps_start=EPS_START, eps_decay=EPS_DECAY, eps_min=EPS_MIN):
    ...
    policy, Q  = await mc_control(NUM_EPISODES,ALPHA)
